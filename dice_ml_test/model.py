"""モデルの選択を行うClass. 必要に応じてdecideメソッドを修正."""
...
class Model:
    ...
    def __init__(self, model=None, model_path='', backend=BackEndTypes.Tensorflow1, model_type=ModelTypes.Classifier,
        ...
        :param backend: "TF1" ("TF2") for TensorFLow 1.0 (2.0), "PYT" for PyTorch implementations,
                        ...
                        inside the subpackage model_interfaces, and dice interface class "DiceXGBoost"
                        in module "dice_xgboost" inside explainer_interfaces, then backend parameter
...
def decide(backend):
    """backendによって使用するライブラリのモデルを使い分ける"""
    """Decides the Model implementation type.
    ...
    if backend == BackEndTypes.Sklearn:
        ...
        from model_interfaces.keras_tensorflow_model import KerasTensorFlowModel
        ...
        module = __import__("model_interfaces." + module_name, fromlist=[class_name])
